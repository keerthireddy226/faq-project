    ...
    <section className="bg-[#fbfbf7] px-5 py-12 lg:py-16">
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <h1 className="max-w-3xl text-[44px] font-extrabold leading-[0.95] tracking-[-0.04em] text-[#07162c] md:text-[64px]">
            ML Model{" "}
            <span className="font-serif italic font-normal text-[#6b8f00]">
              Monitoring
            </span>
            <br />
            Corporate Training
          ...
          <p className="mt-5 max-w-md font-serif text-xl italic leading-8 text-[#07162c]">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="w-full max-w-[520px] rounded-[22px] bg-[#07162c] p-8 text-white shadow-xl">
            ...
            <div className="relative mx-auto flex h-[250px] w-[250px] items-center justify-center">
              ...
              <div className="z-10 flex h-[95px] w-[95px] items-center justify-center rounded-full bg-lime-300 text-center text-sm font-extrabold leading-4 text-[#07162c]">
                Model
                <br />
                health
              </div>
...
function InfoCard({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5">
      ...
      <p className="mt-3 text-base font-extrabold text-[#07162c]">{value}</p>
